//! Pure LanceDB vectorstore logic — no Tauri, no AppHandle.
//!
//! All 11 public functions are called by thin `#[tauri::command]` wrappers
//! in `commands::vectorstore`. Adding HTTP handlers in Phase 4 should only
//! require calling these functions directly.
...
// ──────────────────────────────────────────────────────────────────────────
// Public API — v2 chunk-level vector store
//
